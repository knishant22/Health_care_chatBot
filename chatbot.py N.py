...
training_dataset = pd.read_csv('C:/Users/nisha/Downloads/trainning.csv')
test_dataset = pd.read_csv('C:\\Users\\nisha\\Downloads\\testv.csv')
#df =pd.read_csv('C:/Users/Ravi kant/Downloads/archive (1)/intents.json')
...
doc_dataset = pd.read_csv('C:\\Users\\nisha\\Downloads\\Doctor dataset new.csv', names = ['Name', 'Description'])
...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Health Care Chatbot", bg="PeachPuff2", width="1300", height="4", font=("Calibri", 17))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login", height="3", width="1300", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="3", width="1300", command = self.btnRegister_Click)
        self.btnRegister.pack()
        self.lblTeam=Label(self, text="Made by:", bg="slateblue4", width = "1300", height = "2", font=("Calibri", 17))
        self.lblTeam.pack()
        self.lblTeam2=Label(self, text="Nishant kumar", bg="blue", width = "1300", height = "2", font=("Calibri", 17))
        self.lblTeam2.pack()
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below to login",bg="PeachPuff2",width=32, height=3)
        self.lblMsg.pack()
        self.username=Label(self, text="Username * ", width=15, height=2)
        self.username.pack()
        self.username_verify = StringVar()
        self.username_login_entry = Entry(self, textvariable=self.username_verify)
        self.username_login_entry.pack()
        self.password=Label(self, text="Password * ", width=15, height=2)
        self.password.pack()
        self.password_verify = StringVar()
        self.password_login_entry = Entry(self, textvariable=self.password_verify, show='*')
        self.password_login_entry.pack()
        self.btnLogin=Button(self, text="Login", width=16, height=2, command=self.btnLogin_Click)
        self.btnLogin.pack()
...
class SignUp(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below", bg="PeachPuff2",width=32, height=3)
        self.lblMsg.pack()
        self.username_lable = Label(self, text="Username * ",width=15, height=2)
        self.username_lable.pack()
        self.username = StringVar()
        self.username_entry = Entry(self, textvariable=self.username)
        self.username_entry.pack()

        self.password_lable = Label(self, text="Password * ", width=15, height=2)
        self.password_lable.pack()
        self.password = StringVar()
        self.password_entry = Entry(self, textvariable=self.password, show='*')
        self.password_entry.pack()
        self.btnRegister=Button(self, text="Register", width=16, height=3, bg="blue", command=self.register_user)
        self.btnRegister.pack()
    ...
    def register_user(self):
        ...
        self.lblSucess=Label(root, text="Registration Success", fg="green", font=("calibri", 16))
        self.lblSucess.pack()
